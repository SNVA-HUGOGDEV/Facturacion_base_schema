...
class ResCompany(models.Model):
    ...
    send_on_post = fields.Boolean(string='Enviar al postear', default=True, help='Enviar la factura a la DIAN al postear la factura.')
    async_mode = fields.Boolean(string='Modo asíncrono', default=False, help='Enviar la factura a la DIAN en modo asíncrono.')