...
{   'name': 'DIAN Data Fields',
    ...
    'depends': [   'base',
                   ...
                   'hr',
                   'hr_contract'],
    'data': [   'security/l10n_co_account_fiscal_position_party_tax_scheme/ir.model.access.csv',
                ...
                'views/l10n_co_employee/hr_employee_views.xml',
                'views/l10n_co_contract/hr_contract_type_views.xml',
                'views/l10n_co_contract/hr_contract_views.xml'],
    'installable': True,
    'auto_install': False}
